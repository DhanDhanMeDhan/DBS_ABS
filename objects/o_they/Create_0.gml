...
spr_casual_idle_down=s_they_walk;
spr_casual_idle_downleft=s_they_walk;
spr_casual_idle_downright=s_they_walk;
spr_casual_idle_left=s_they_walk;
spr_casual_idle_right=s_they_walk;
spr_casual_idle_up=s_they_walk;
spr_casual_idle_upleft=s_they_walk;
spr_casual_idle_upright=s_they_walk;
#endregion
//============================================================
#region walk animation
spr_casual_walk_down=s_they_walk;
spr_casual_walk_downleft=s_they_walk;
spr_casual_walk_downright=s_they_walk;
spr_casual_walk_left=s_they_walk;
spr_casual_walk_right=s_they_walk;
spr_casual_walk_up=s_they_walk;
spr_casual_walk_upleft=s_they_walk;
spr_casual_walk_upright=s_they_walk;
#endregion
//============================================================
#region talk animation
spr_casual_talk_down=s_they_walk;
spr_casual_talk_downleft=s_they_walk;
spr_casual_talk_downright=s_they_walk;
spr_casual_talk_left=s_they_walk;
spr_casual_talk_right=s_they_walk;
spr_casual_talk_up=s_they_walk;
spr_casual_talk_upleft=s_they_walk;
spr_casual_talk_upright=s_they_walk;
#endregion
#endregion
//============================================================
#region pijama
