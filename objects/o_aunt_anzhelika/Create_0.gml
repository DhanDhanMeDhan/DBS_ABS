...
ppl_face_portrait=-1;
ppl_scr_cutscene=-1;
ppl_name=["Tia Anzhelika","Tía Anzhelika","Aunt Anzhelika"];
ppl_voice=dag_002;
ppl_flowing=true;
...
spr_casual_idle_down=s_aunt_anzhelika_casual_idle_1_down;
spr_casual_idle_downleft=s_aunt_anzhelika_casual_idle_1_downleft;
spr_casual_idle_downright=s_aunt_anzhelika_casual_idle_1_downright;
spr_casual_idle_left=s_aunt_anzhelika_casual_idle_1_left;
spr_casual_idle_right=s_aunt_anzhelika_casual_idle_1_right;
spr_casual_idle_up=s_aunt_anzhelika_casual_idletalk_1_up;
spr_casual_idle_upleft=s_aunt_anzhelika_casual_idletalk_1_upleft;
spr_casual_idle_upright=s_aunt_anzhelika_casual_idletalk_1_upright;
#endregion
//============================================================
#region walk animation
spr_casual_walk_down=s_aunt_anzhelika_casual_walk_1_down;
spr_casual_walk_downleft=s_aunt_anzhelika_casual_walk_1_downleft;
spr_casual_walk_downright=s_aunt_anzhelika_casual_walk_1_downright;
spr_casual_walk_left=s_aunt_anzhelika_casual_walk_1_left;
spr_casual_walk_right=s_aunt_anzhelika_casual_walk_1_right;
spr_casual_walk_up=s_aunt_anzhelika_casual_walk_1_up;
spr_casual_walk_upleft=s_aunt_anzhelika_casual_walk_1_upleft;
spr_casual_walk_upright=s_aunt_anzhelika_casual_walk_1_upright;
#endregion
//============================================================
#region talk animation
spr_casual_talk_down=s_aunt_anzhelika_casual_talk_1_down;
spr_casual_talk_downleft=s_aunt_anzhelika_casual_talk_1_downleft;
spr_casual_talk_downright=s_aunt_anzhelika_casual_talk_1_downright;
spr_casual_talk_left=s_aunt_anzhelika_casual_talk_1_left;
spr_casual_talk_right=s_aunt_anzhelika_casual_talk_1_right;
spr_casual_talk_up=s_aunt_anzhelika_casual_idletalk_1_up;
spr_casual_talk_upleft=s_aunt_anzhelika_casual_idletalk_1_upleft;
spr_casual_talk_upright=s_aunt_anzhelika_casual_idletalk_1_upright;
#endregion
#endregion
//============================================================
#region pijama
