draw_sprite_ext(sprite_index,image_index,x-global.cx,y-global.cy,1,1,0,c_red,1);
...
var i=0 repeat array_length(global.party){
	//draw_text_color(global.cw/2,(global.ch/2)+(i*16),string(global.party[i][0]),c_black,c_black,c_black,c_black,1);
	i++;
}
//if(instance_exists(o_bunbun)) draw_text_color(global.cw/2,global.ch/2,o_bunbun.ppl_talked,c_black,c_black,c_black,c_black,1);