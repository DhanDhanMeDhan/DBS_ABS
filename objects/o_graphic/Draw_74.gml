...
if(surface_exists(_surf)){
	...
	for(var i=0;i<floors;i++){
		...
		//draw_surface_ext(ds_tld[i][2][1],-global.cx,-global.cy,1,1,0,_c,ds_tld[i][5]);
		var _xx=global.cx/3;
		var _yy=global.cy/3;
		var _yy_limt=(room_height-global.ch)/3;
		draw_surface_ext(ds_tld[i][3][0],_xx-global.cx,_yy-global.cy,1,1,0,_c,ds_tld[i][5]);
		draw_surface_ext(ds_tld[i][3][1],_xx-global.cx,_yy-global.cy,1,1,0,_c,ds_tld[i][5]);
		draw_surface_ext(ds_tld[i][4][0],_xx-global.cx,_yy-global.cy,1,1,0,_c,ds_tld[i][5]);
		draw_surface_ext(ds_tld[i][4][1],_xx-global.cx,_yy-global.cy,1,1,0,_c,ds_tld[i][5]);
	}
