...
for(var i=0;i<floors;i++){
	for(var k=0;k<5;k++){
		var _str="TLD_Floor_"+string(k+1)+"_"+string(i+1);
		if(layer_exists(_str)){
			var _lay=layer_get_id(_str);
			layer_set_visible(_lay,false);
			surface_set_target(ds_tld[i][0][k]);
			draw_tilemap(layer_tilemap_get_id(_lay),0,0);
			surface_reset_target();
		}
		//============================================================
		var _str="TLD_Top_"+string(k+1)+"_"+string(i+1);
		if(layer_exists(_str)){
			var _lay=layer_get_id(_str);
			layer_set_visible(_lay,false);
			surface_set_target(ds_tld[i][1][k]);
			draw_tilemap(layer_tilemap_get_id(_lay),0,0);
			surface_reset_target();
		}
	}
...
for(var i=0;i<floors;i++){
	#region bottom
	for(var k=0;k<5;k++){
		var _lay_str="TLD_Floor_"+string(1)+"_"+string(i+1)+"_"+string(k+1);
		if(layer_exists(_lay_str)){
			...
			var _lay_str="TLD_Floor_"+string(1+1)+"_"+string(i+1)+"_"+string(k+1);
			if(layer_exists(_lay_str)){
				var _lay_id=layer_get_id(_lay_str);
				layer_set_visible(_lay_id,false);
	...
	#region top
	for(var k=0;k<5;k++){
		var _lay_str="TLD_Top_"+string(1)+"_"+string(i+1)+"_"+string(k+1);
		if(layer_exists(_lay_str)){
			var _lay_id=layer_get_id(_lay_str);
			layer_set_visible(_lay_id,false);
			#region
			...
			var _lay_str="TLD_Top_"+string(1+1)+"_"+string(i+1)+"_"+string(k+1);
			if(layer_exists(_lay_str)){
				var _lay_id=layer_get_id(_lay_str);
				layer_set_visible(_lay_id,false);
				#region
	...
	#region top
	for(var k=0;k<5;k++){
		var _lay_str="TLD_Top_Leaves_"+string(1)+"_"+string(i+1)+"_"+string(k+1);
		if(layer_exists(_lay_str)){
			var _lay_id=layer_get_id(_lay_str);
			layer_set_visible(_lay_id,false);
			#region
			...
			var _lay_str="TLD_Top_Leaves_"+string(1+1)+"_"+string(i+1)+"_"+string(k+1);
			if(layer_exists(_lay_str)){
				var _lay_id=layer_get_id(_lay_str);
				layer_set_visible(_lay_id,false);
				#region
