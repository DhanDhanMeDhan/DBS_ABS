...
var gui_to_draw_size=array_length(gui_to_draw);
for(var i=0;i<gui_to_draw_size;i++){
	if(instance_exists(gui_to_draw[i])){with(gui_to_draw[i]){event_perform(ev_draw,ev_gui);}}
}
...
if(global.time==time.night){
	_c_bg=make_color_rgb(64,51,83);
}else{
	_c_bg=c_white;
}
//============================================================
var _lay=layer_get_id("Background");
var _bg_lay=layer_background_get_id(_lay);
layer_background_blend(_bg_lay,_c_bg);
//============================================================
...
var _lay=layer_get_id("Background");
var _bg_lay=layer_background_get_id(_lay);
layer_background_blend(_bg_lay,c_red);
