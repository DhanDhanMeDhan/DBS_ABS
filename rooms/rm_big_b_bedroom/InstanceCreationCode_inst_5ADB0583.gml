quest_array=[
	...
	[0,quest_type.talk_to,o_big_b_bedroom_detail_6_1],
];
...
non_complete_cutscene[1]=[
	[scr_cutscene_bars,true,true],
	[scr_cutscene_wait,1],
	[scr_cutscene_variable,variable.normal,o_big_b_bedroom_detail_6_1,"image_index",1],
	[scr_cutscene_variable,variable.normal,o_big_b_bedroom_detail_6_1,"ppl_talked",true],
	[scr_cutscene_wait,1],
