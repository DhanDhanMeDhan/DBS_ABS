...
non_avaliable_cutscene=[
	...
	[scr_cutscene_variable,variable.normal,o_bunbun,"x",745],
	[scr_cutscene_variable,variable.normal,o_bunbun,"y",262],
	[scr_cutscene_refresh_party_member,true],
	[scr_cutscene_variable,variable.normal,o_camera,"x",745],
	...
	[scr_cutscene_wait,1],
	[scr_cutscene_variable,variable.nearst,o_door_1,"open",true,745,278],
	[scr_cutscene_wait,1],
	[scr_cutscene_move_character,o_bunbun,745,278,false,1,true,true],
	[scr_cutscene_refresh_party_member,false],
	[scr_cutscene_wait,1],
	[scr_cutscene_variable,variable.normal,o_camera,"flow_npc",true],
	[scr_cutscene_variable,variable.nearst,o_door_1,"open",false,745,278],
	[scr_cutscene_wait,1],
