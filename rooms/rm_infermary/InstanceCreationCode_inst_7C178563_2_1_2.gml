non_avaliable_cutscene=[
	...
	[scr_cutscene_variable,variable.normal,o_bunbun,"x",827],
	[scr_cutscene_variable,variable.normal,o_bunbun,"y",436],
	[scr_cutscene_refresh_party_member,true],
	[scr_cutscene_variable,variable.normal,o_camera,"flow_npc",false],
	[scr_cutscene_variable,variable.normal,o_camera,"x",827],
	[scr_cutscene_variable,variable.normal,o_camera,"y",336],
	...
	[scr_cutscene_wait,1],
	[scr_cutscene_move_character,o_bunbun,827,336,false,1,true,true],
