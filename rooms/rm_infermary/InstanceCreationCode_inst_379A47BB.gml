non_avaliable_cutscene=[
	...
	[scr_cutscene_move_character,o_bunbun,495,563,false,1,true,true],
	[scr_cutscene_wait,1],
	...
	[scr_cutscene_variable,variable.normal,o_bunbun,"x",757],
	[scr_cutscene_variable,variable.normal,o_bunbun,"y",507],
	[scr_cutscene_refresh_party_member,true],
	[scr_cutscene_variable,variable.normal,o_camera,"flow_npc",false],
	[scr_cutscene_variable,variable.normal,o_camera,"x",744],
	[scr_cutscene_variable,variable.normal,o_camera,"y",524],
	...
	[scr_cutscene_wait,1],
	[scr_cutscene_move_character,o_bunbun,757,521,false,1,true,true],
	[scr_cutscene_move_character,o_bunbun,747-3,527+3,false,1,true,true],
	[scr_cutscene_variable,variable.normal,o_camera,"flow_npc",true],
	[scr_cutscene_refresh_party_member,false],
	[scr_cutscene_wait,1],
	[scr_cutscene_variable,variable.nearst,o_door_3,"open",false,748,507],
	[scr_cutscene_wait,1],
