	...
	case 0: 
		if(global.event[0][0]==progress.non_complete){
			...
			non_complete_cutscene[0]=[
				...
				[scr_cutscene_circle_wake_up,true,true,-1,-1,true,false,false,make_color_rgb(36,34,52)],//[scr_cutscene_transition,cutscene_transition_type.bars,true,true,-1,make_color_rgb(36,34,52)],
				[scr_cutscene_room_goto,rm_g_bedroom_1,true,false],
				[scr_cutscene_instance_create,653,394,"Instances_People_2",o_calina],
				[scr_cutscene_instance_create,553,369,"Instances_People_2",o_danya],
				[scr_cutscene_instance_create,578,369,"Instances_People_2",o_darya],
				[scr_cutscene_animation_sprite,o_calina,[s_calina_casual_chill_3_idle_0],[s_calina_casual_chill_3_idle_0],false,true,[.25,.25]],
				[scr_cutscene_animation_sprite,o_danya,[s_danya_casual_chill_3_idle_0],[s_danya_casual_chill_3_idle_0],false,true,[.25,.25]],
				[scr_cutscene_animation_sprite,o_darya,[s_darya_casual_chill_3_idle_0],[s_darya_casual_chill_3_idle_0],false,true,[.25,.25]],
				[scr_cutscene_variable,variable.normal,o_bunbun,"x",652],
				[scr_cutscene_variable,variable.normal,o_bunbun,"y",541],
				[scr_cutscene_refresh_party_member,true],
				[scr_cutscene_variable,variable.normal,o_camera,"x",652],
