...
non_avaliable_cutscene=[
	...
	[scr_cutscene_variable,variable.normal,o_bunbun,"x",666],
	[scr_cutscene_variable,variable.normal,o_bunbun,"y",583],
	[scr_cutscene_refresh_party_member,true],
	[scr_cutscene_variable,variable.normal,o_camera,"x",666],
	...
	[scr_cutscene_wait,1],
	[scr_cutscene_move_character,o_bunbun,666,483,false,1,true,true],
