...
complete_cutscene=[
	...
	[scr_cutscene_instance_create,547,296,"Instances_People_1",o_gratuated],
	...
	[scr_cutscene_condition,question.have_person,o_todd,
		[
			[
				...
				[scr_cutscene_variable,variable.normal,o_graphic,"graphic_custom_bg",true],
				[scr_cutscene_variable,variable.normal,o_l_basement_light,"light_set_alpha",1],
				[scr_cutscene_move_character,o_gratuated,704,296,false,1,false,false],
				[scr_cutscene_wait,1],
				[scr_cutscene_talk,cutscene_talk_mode.normal,o_bunbun,["Ah..."]],
				[scr_cutscene_move_character,o_gratuated,0,8,true,1,false,false],
				[scr_cutscene_wait,1],
				...
				[scr_cutscene_screen_shake,.25,4,false],
				...
				[scr_cutscene_variable,variable.normal,o_gratuated,"ppl_act_state",ppl_act.run],
				[scr_cutscene_screen_shake,.25,4,true],
